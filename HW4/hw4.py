#########################################
# NO OTHER PACKAGE IMPORTS ARE ALLOWED  #
#########################################
...
def fk_1(theta):
    ...
    """
    # Specify all twists.
    # Three revolute joints about z, y, x through the origin respectively.
    xi_1 = [0, 0, 0, 0, 0, 1]
    xi_2 = [0, 0, 0, 0, 1, 0]
    xi_3 = [0, 0, 0, 1, 0, 0]
...
def fk_2(theta):
    ...
    """
    # Specify all twists.
    # Joint 1: helical joint about z through origin with pitch 2.
    xi_1 = [0, 0, 2, 0, 0, 1]
    # Joint 2: revolute about y at z = L1.
    xi_2 = [-10, 0, 0, 0, 1, 0]
    # Joint 3: revolute about x through q3 = [0, L2, L1-L3].
    xi_3 = [0, 5, -5, 1, 0, 0]
...
def fk_3(theta):
    ...
    """
    # Specify all twists.
    # Stanford arm: revolute, revolute, prismatic, revolute, revolute, revolute.
    xi_1 = [0, 0, 0, 0, 0, 1]
    xi_2 = [0, -1, 0, -1, 0, 0]
    xi_3 = [0, 1, 0, 0, 0, 0]
    xi_4 = [1, 0, 0, 0, 0, 1]
